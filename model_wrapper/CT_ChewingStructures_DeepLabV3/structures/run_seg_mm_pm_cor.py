...
# Date: Oct 10, 2019
# Description: Script to segment masseters (left and right) and medial pterygoids (left and right) from coronal CT images
# Architecture :  Deeplab v3+ with resnet backbone
# Usage: python run_seg_mm_pm_cor.py [argv] [path to input 2D coronal H5 files]
...
class Trainer(object):
    def __init__(self, inputDir, batchSize):
        ...
        #modelPath = os.path.join(pDir,'model','MM_PM_Cor_model.pth.tar')
        self.modelPath = '/software/model/MM_PM_Cor_model.pth.tar'
