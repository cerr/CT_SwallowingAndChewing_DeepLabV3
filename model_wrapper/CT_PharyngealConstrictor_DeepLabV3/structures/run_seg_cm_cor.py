...
# Date: Oct 10, 2019
# Description: Script to segment the pharyngeal constrictor muscle from coronal CT images
# Architecture :  Deeplab v3+ with resnet backbone
# Usage: python run_seg_cm_cor.py [argv] [path to input 2D coronal H5 files]
...
class Trainer(object):
    def __init__(self, inputDir, batchSize):
        ...
        #modelPath = os.path.join(pDir,'model','CM_Cor_model.pth.tar')
        self.modelPath = '/software/model/CM_Cor_model.pth.tar'
