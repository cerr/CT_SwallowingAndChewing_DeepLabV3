...
# Date: Oct 10, 2019
# Description: Script to segment the pharyngeal constrictor muscle from axial CT images
# Architecture :  Deeplab v3+ with resnet backbone
# Usage: python run_seg_cm_ax.py [argv] [path to input 2D axial H5 files]
...
class Trainer(object):
    def __init__(self, inputDir, batchSize):
        ...
        #modelPath = os.path.join(pDir,'model','CM_Ax_model.pth.tar')
        self.modelPath = '/software/model/CM_Ax_model.pth.tar'
