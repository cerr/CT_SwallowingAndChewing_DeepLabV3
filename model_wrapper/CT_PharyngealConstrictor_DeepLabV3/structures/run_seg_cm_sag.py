...
# Date: Oct 10, 2019
# Description: Script to segment the pharyngeal constrictor muscle from sagittal CT images
# Architecture :  Deeplab v3+ with resnet backbone
# Usage: python run_seg_cm_sag.py [argv] [path to input 2D sagittal H5 files]
...
class Trainer(object):
    def __init__(self, inputDir, batchSize):
        ...
        #modelPath = os.path.join(pDir,'model','CM_Sag_model.pth.tar')
        self.modelPath = '/software/model/CM_Sag_model.pth.tar'
